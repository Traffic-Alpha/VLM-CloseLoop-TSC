...
LastEditTime: 2025-04-22 14:39:42
'''
import numpy as np
...
class TSCEnvWrapper(gym.Wrapper):
    ...
    """
    def __init__(self, env: Env, tls_id:str, number_phases:int, max_states:int=5) -> None:
        super().__init__(env)
    ...
    def state_wrapper(self, state):
        ...
        """
        occupancy = state['tls'][self.tls_id]['last_step_occupancy'] # 返回一个长度为 12 的列表, 表示每一个 movement 的占有率
